...
public class UserServiceImpl extends UserServiceGrpc.UserServiceImplBase {
    ...
    @Autowired
    public UserServiceImpl(BusinessRepository businessRepository, CustomerRepository customerRepository) {
        this.businessRepository = businessRepository;
        this.customerRepository = customerRepository;
    }

    @Override
    public void getUserByEmail(UserByEmailRequest request, StreamObserver<UserResponse> responseObserver) {
        ...
        responseObserver.onError(new IllegalArgumentException("User not found with email: " + email));
    }
