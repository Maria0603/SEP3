package com.example.sep_poc;

import com.example.sep_poc.Services.CollectService.CollectServiceImpl;
import com.example.sep_poc.Services.FoodManagementService.FoodManagementServiceImpl;
...
@EnableCaching
public class SepPocApplication
{
  @Autowired
  ...
  {
    SpringApplication.run(SepPocApplication.class, args);
