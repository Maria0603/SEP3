...
public class CreateOfferRequestDto
{
  ...
  @NotNull(message = "Pickup start time must be provided") private LocalDateTime pickupTimeStart;

  @NotNull(message = "Pickup end time must be provided") private LocalDateTime pickupTimeEnd;
