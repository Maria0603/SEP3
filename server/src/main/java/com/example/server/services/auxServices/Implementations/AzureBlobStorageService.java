...
@Service public class AzureBlobStorageService implements IImageStorageService
{
  ...
  public AzureBlobStorageService(AzureBlobStorageConfig azureBlobStorageConfig)
  {
    BlobServiceClient blobServiceClient = new BlobServiceClientBuilder().connectionString(
        azureBlobStorageConfig.getConnectionString()).buildClient();
  ...
  @Override public void updateImage(String imagePath, byte[] newImageData)
      throws IOException
  {
